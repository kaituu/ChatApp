...
public class ClientGui extends Thread {
    ...
    public ClientGui(ChatController chatController) {
    ...
    private void leggoSocket() {
        for (; ; ) {
            //Leggo dal socket
            stringaRicevutaDalServer = ricevoDalServer();    //ricevoDalServer();
            //Stampo a schermo
            chatController.stampaMessaggio(stringaRicevutaDalServer);
        }
    }
